...
final class QuizController extends AbstractController
{
    ...
    public function index($mission_id, $question_id, MissionRepository $missionRepository, QuestionRepository $questionRepository, Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $answeredQuestion->setOptione($data['option']);
